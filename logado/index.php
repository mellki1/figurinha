...
<div class="row">
  <div class="col-lg-12">
    <h2 class="my-4">Suas figurinhas</h2>
  </div>
  <div class="">
            <?php
                ...
                if($vetor != -1){
                    foreach ($vetor as $key => $valor) {
                        echo "<img class='figure-img img-fluid rounded' src='img/$valor[caminho]' alt=' 'style='padding-right: 10px;'>'";
                    }
                }else{
        ...
        <div class="form-group text-center">
            <a href="ganhar.php"><button name='ganhar' class="btn btn-primary btn-sm">Ganhar Figurinhas</button></a>
            <a href="deslogar.php"><button name='deslogar' class="btn btn-primary btn-sm">Sair</button></a>
        </div>
