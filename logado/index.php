...
<html>
    ...
    <body class="text-center">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="index.php">Yoda Face Card</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="ganhar.php">Ganhar figurinhas do dia</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Liberar figurinhas para troca</a>
                    </li>
                    <li class="nav-item">
